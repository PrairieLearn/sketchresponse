...
problemconfig = sketchresponse.config(
    {
        ...
        "plugins": [
            ...
            },
            {
                ...
                "hollow": False,
                "readonly": True,
                "tag": {"value": "tag", "xoffset": 5, "yoffset": -5, "align": "start"},
            },
            {
                "name": "line-segment",
                "id": "ls",
            ...
            },
            {
                ...
                "label": "CWM",
                "scale": 0.5,
                "src": "/static/examples/cw_moment.png",
                "readonly": True,
            },
            {
                "name": "stamp",
                ...
                "label": "CCWM",
                "scale": 0.5,
                "src": "/static/examples/ccw_moment.png",
                "readonly": True,
            },
        ],
        "initialstate": {
            "pl": [[{"y": 41, "x": 93}, {"y": 293, "x": 94}, {"y": 293, "x": 563}], []],
            "pt": [{"y": 41, "x": 93, "tag": "A"}, {"y": 293, "x": 563, "tag": "B"}],
            "ls": [{"y": 344, "x": 468}, {"y": 296, "x": 468}],
            "c": [{"y": 256, "x": 187, "tag": "C"}, {"y": 345, "x": 187}],
            "cwm": [{"y": 126, "x": 93}],
            "ccwm": [{"y": 293, "x": 280}],
        },
    }
