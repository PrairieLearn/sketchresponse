...
problemconfig = sketchresponse.config(
    {
        ...
        "plugins": [
            ...
            },
            {
                ...
                "label": "Left Wall",
                "scale": 2.0,
                "src": "/static/simona_stamps/left_wall.png",
                "readonly": True,
            },
            {
                "name": "stamp",
                ...
                "label": "Right Wall",
                "scale": 2.0,
                "src": "/static/simona_stamps/right_wall.png",
                "readonly": True,
            },
            {
                "name": "polyline",
            ...
            },
            {
                ...
                "label": "Slider",
                "scale": 1.25,
                "src": "/static/simona_stamps/slider.png",
                "readonly": True,
            },
            {
                "name": "line-segment",
            ...
            },
            {
                ...
                "label": "Plate",
                "scale": 1.0,
                "src": "/static/simona_stamps/plate.png",
                "readonly": True,
            },
            {
                "name": "polyline",
        ...
        "initialstate": {
            "b1": [[{"y": 153, "x": 255}, {"y": 153, "x": 532}], []],
            "b2": [[{"y": 218, "x": 255}, {"y": 217, "x": 532}], []],
            "lw": [{"y": 168, "x": 248}],
            "blk": [
                [
                    {"y": 235, "x": 533},
...
def grader(b1, b2, b3, lw, rw, blk, sl, force, plate, iso):
    ...
    if len(iso_bub.get_intersections_with_polygon_boundary(bar1_line, iso_poly)) != 1:
