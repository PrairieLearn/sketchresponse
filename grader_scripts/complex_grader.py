...
def grader(f, cp, ip, va, ha):
    ...
    if va.get_number_of_asyms() != 2:
        msg += (
            '<font color="blue"> Are you sure about the number of vertical asymptotes?</font><br />'
        )
    ...
    if msg != "":
        ...
        curvature_up_ok = f.has_positive_curvature_between(
            -4, -1
        ) and f.has_positive_curvature_between(1, 4)
