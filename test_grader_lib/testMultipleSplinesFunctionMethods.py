...
class TestMultipleSplinesFunctionMethods(TestData.TestData):
    ...
    def test_false_has_curvature_between(self):
        ...
        for d in data:
            ...
            self.assertFalse(f.has_curvature_between(-1, 1))
    ...
    def test_true_does_not_exist_between(self):
        ...
        for d in data:
            ...
            # tolerance=2 accounts for slight pixel imprecision in hand-drawn test data
            self.assertTrue(f.does_not_exist_between(-2, 0, tolerance=2))
