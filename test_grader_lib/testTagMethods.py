...
class TestTagMethods(TestData.TestData):
    ...
    def test_point_has_tag_true(self):
        ...
        d = data[0]
        args = d["pt"]
        pt = GradeableFunction.GradeableFunction(args.grader, args.submission, args.submission["meta"]["config"], args.tool_id)
    ...
    def test_line_segment_has_tag_true(self):
        ...
        d = data[0]
        args = d["ls"]
        ls = LineSegment.LineSegments(args.grader, args.submission, args.submission["meta"]["config"], args.tool_id)
    ...
    def test_polygon_has_tag_true(self):
        ...
        d = data[0]
        args = d["pg"]
        pg = Polygon.Polygons(args.grader, args.submission, args.submission["meta"]["config"], args.tool_id)
